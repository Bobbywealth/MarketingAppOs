...
export function TaskDetailSidebar({ task, isOpen, onClose, onEdit }: TaskDetailSidebarProps) {
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      case "urgent": return "bg-red-500/10 text-red-700 border-red-200 dark:border-red-900";
      case "high": return "bg-orange-500/10 text-orange-700 border-orange-200 dark:border-orange-900";
      case "normal": return "bg-blue-500/10 text-blue-700 border-blue-200 dark:border-blue-900";
      case "low": return "bg-slate-500/10 text-slate-700 border-slate-200 dark:border-slate-900";
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "completed": return "bg-green-500/10 text-green-700 border-green-200 dark:border-green-900";
      case "review": return "bg-purple-500/10 text-purple-700 border-purple-200 dark:border-purple-900";
      case "in_progress": return "bg-amber-500/10 text-amber-700 border-amber-200 dark:border-amber-900";
      case "todo": return "bg-slate-500/10 text-slate-700 border-slate-200 dark:border-slate-900";
      default: return "bg-slate-500/10 text-slate-700";
    }
  };
      ...
      <SheetContent className="sm:max-w-xl p-0 flex flex-col h-full border-l-0 shadow-2xl">
        ...
        <ScrollArea className="flex-1">
          <div className="p-6 space-y-8 pb-32">
            ...
            {/* Media/Attachments UI (Placeholder) */}
            <div className="space-y-4">
              <h3 className="text-sm font-bold flex items-center gap-2 uppercase tracking-widest text-muted-foreground">
