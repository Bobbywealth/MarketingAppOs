      ...
      <div className="p-4 md:p-6 lg:p-8 xl:p-12 space-y-4 md:space-y-6 lg:space-y-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="space-y-1 md:space-y-2">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-gradient-purple">Subscription Packages</h1>
            <p className="text-sm md:text-base lg:text-lg text-muted-foreground">Manage your pricing tiers and subscription plans</p>
          </div>
