...
const trainingContent: TrainingSection[] = [
  ...
  },
  {
    ...
    icon: Ticket,
    category: "Communication",
    content: "Track and manage client support requests. Clients can submit tickets, and admins/staff can resolve them.",
    steps: [
      "Admin View: See all support tickets from all clients",
      "Client View: Create support tickets for help requests",
    ...
    tips: [
      "Clients can only create tickets, not update status",
      "Prioritize urgent tickets for faster response",
      "Use clear subjects for easy ticket identification",
      "Close tickets once fully resolved",
    ],
  },
  {
    id: "website-projects",
  ...
  },
  {
    ...
    icon: Package,
    category: "Finance",
    content: "Create and manage subscription tiers that clients can purchase on your landing page. Control pricing, features, and billing.",
    steps: [
    ...
    tips: [
      ...
      "Use Stripe integration for automated billing",
