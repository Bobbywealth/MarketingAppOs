            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-2xl font-bold">
                  {stats?.completedTasksToday || 0}/{stats?.totalTasksToday || 0}
                </p>
                <p className="text-xs text-muted-foreground">Completed</p>
              </div>
            </div>
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              <div>
                ...
                <Progress 
                  value={stats?.totalTasksToday > 0 
                    ? (stats?.completedTasksToday / stats?.totalTasksToday) * 100
                    : 0
                  } 
                  className="h-3"
                />
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                <div className="space-y-1">
                  ...
                  <p className="text-lg font-bold">{stats?.todoTasksToday || 0}</p>
                </div>
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-lg font-bold">{stats?.inProgressTasksToday || 0}</p>
                </div>
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-lg font-bold">{stats?.reviewTasksToday || 0}</p>
                </div>
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-lg font-bold">{stats?.completedTasksToday || 0}</p>
                </div>
              </div>
            </div>
          </CardContent>
